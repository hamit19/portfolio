...
function Layout({ children, setOpen }) {
  ...
  return (
    <div className='bg-slate-900 lg:!text-xl xl:!text-2xl'>
      <div className='container lg:!text-xl xl:!text-2xl'>
        <nav
        ...
        >
          <a href='#home'>
            <h1 className='text-xl font-bold text-indigo-300 text-shadow lg:!text-lg xl:!text-2xl'>
              Hamid Hassani
            </h1>
          </a>
          ...
          <button
            ...
            className='hidden px-6 py-2 text-sm font-medium text-indigo-300 bg-transparent border border-indigo-300 rounded-md shadow-xl cursor-pointer lg:text-lg md:inline-block hover:bg-indigo-400 custom-transition hover:text-gray-100 '
          >
            Contact Me
          </button>
        </nav>
